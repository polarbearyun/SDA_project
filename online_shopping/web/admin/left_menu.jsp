...
<nav class="menu" id="mymenu">
    <ul class="nav nav-primary">
        <li class="nav-parent show"><a href="javascript:;"> Product Management</a>
            <ul class="nav">
        ...
        <li class="nav-parent show"><a href="javascript:;"> User Management</a>
            <ul class="nav">
        ...
        <li class="nav-parent show"><a href="javascript:;"> Order Management</a>
            <ul class="nav">
