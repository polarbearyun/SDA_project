                ...
                <div class="panel" style="border: none;">
                    ...
                    <div class="panel-body">
                        <form action="${ctx}/admin/editProduct" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" name="picture" id="picture" value="${product.picture}"
                                       placeholder="Picture URL" class="form-control input-lg">
                            </div>
                            <div class="form-group">
                                <input type="text" name="inventory" id="inventory" value="${product.inventory}"
                                       placeholder="Inventory" class="form-control input-lg">
                            </div>
                            <div class="form-group">
                                <input type="text" name="price" id="price" value="${product.price.price}"
